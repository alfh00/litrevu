...
urlpatterns = [
    ...
    path(
        "ticket_review/new/",
        feed.views.create_new_ticket_review,
    ...
    path(
        "following_followers_lists/",
        feed.views.following_followers_lists,
        name="following_followers_lists",
    ),
    ...
    path(
        "tickets/<int:ticket_id>/edit_or_delete_review/",
        feed.views.edit_or_delete_review,
        name="edit_or_delete_review",
    ),
    path(
        "tickets/<int:review_id>/delete_review/",
        feed.views.delete_review,
        name="delete_review",
    ),
